...
**Available models:** `kontext`, `nanobanana`, `nanobanana-2`, `nanobanana-pro`, `seedream5`, `seedream`, `seedream-pro`, `gptimage`, `gptimage-large`, `flux`, `zimage`, `klein`, `imagen-4`, `flux-2-dev`, `grok-imagine`, `dirtberry`, `dirtberry-pro`. `zimage` is the default.
