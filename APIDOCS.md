...
**Available models:** `kontext`, `nanobanana`, `nanobanana-pro`, `seedream`, `seedream-pro`, `gptimage`, `gptimage-large`, `flux`, `zimage`, `klein`, `klein-large`, `imagen-4`, `grok-imagine`. `zimage` is the default.
